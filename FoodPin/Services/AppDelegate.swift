...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        //NavigationBar Appearence Customization
       let navBar = UINavigationBar.appearance()
        
        navBar.barTintColor = UIColor(red: 216.0/255.0, green: 74.0/255.0, blue: 32.0/255.0, alpha: 1.0)
        
        navBar.tintColor = UIColor.white
    
        if let barFont = UIFont(name: "Georgia-Bold", size: 24.0){
        navBar.titleTextAttributes = [NSAttributedString.Key.foregroundColor : UIColor.white, NSAttributedString.Key.font : barFont]
        }
